...
multiversx_sc_wasm_adapter::endpoints! {
    ...
    (
        ...
        proposeESDTTransfer => propose_esdt_transfer
        proposeDelegate => propose_delegate
        proposeUndelegate => propose_undelegate
        proposeClaimRewards => propose_claim_rewards
        proposeRedelegate => propose_redelegate
        quorumReached => quorum_reached
        performAction => perform_action_endpoint
    )
}

multiversx_sc_wasm_adapter::async_callback! { multiversx_multisig }
